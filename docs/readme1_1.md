...
| WHO Infodemic Proxies _(Optional)_              | WHO datasets / reports                                                                  | Manual CSV / API                 | Kenya‑specific       | misinfo_event_id, date, topic, severity                                      |
...
**_Focus: A reproducible data pipeline and analytics observatory for understanding civil liberties, conflict dynamics, and censorship patterns._**
