...
description: |
  NEW — Who is requesting content removal? Derived from Google Transparency
  (requestor field) and Lumen (sender field). Critical for the Streamlit
  "Who is censoring Kenya?" dashboard panel.
...
SELECT DISTINCT
    ...
    -- Classify requestor type — critical for "who is suppressing speech" analysis
    CASE
