...
description: |
  Unified list of platforms and services monitored across all three sources:
  OONI (censorship tests), Google Transparency, and Lumen takedown requests.
  Used to join across sources in Streamlit dashboards.
...
WITH combined AS (
    -- OONI: test_name is the platform/protocol being tested
    SELECT DISTINCT
    ...
    -- Google Transparency: product field
    SELECT DISTINCT
    ...
    -- Lumen: recipient is the platform receiving the takedown notice
    SELECT DISTINCT
