...
aggregated AS (
    ...
    SELECT
        ...
        -- COUNTIF was permanently, silently zero. Renamed to count the
        -- real fourth state instead, so blocked+ok+down+unknown now sums
        -- to total_experiment_results exactly.
