...
description: |
  ...
  creates/refreshes a BigQuery external table. BQ reads from GCS directly.
...
GCS_OBJECT = "google/google_transparency_detailed.parquet"
...
def materialize():
    ...
    table_obj.description = (
        "External table — Google Transparency detailed removal requests for Kenya "
